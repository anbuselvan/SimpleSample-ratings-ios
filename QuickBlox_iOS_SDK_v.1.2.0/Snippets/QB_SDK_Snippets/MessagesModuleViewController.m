    ...
    switch (indexPath.section) {
        ...
        case 2:
            switch (indexPath.row) {
                // Create Event
                case 0:{
                    QBMPushEvent *event = [QBMPushEvent pushEvent];
                    event.notificationType = QBMNotificationTypePush;
                    event.pushType = QBMPushTypeAPNS;
                    event.usersIDs = @"292,291";
                    event.isDevelopmentEnvironment = YES;
                    event.type = QBMEventTypeOneShot; 
                    //
                    NSString *mesage = @"New message is available for you";
        ...
        case 3:
            switch (indexPath.row) {
                ...
                case 1:{
                    ...
                    // Send push
                    if(withContext){
                        [QBMessages TSendPush:message toUsers:@"292" isDevelopmentEnvironment:YES delegate:self context:testContext];
                    }else{
                        [QBMessages TSendPush:message toUsers:@"292" isDevelopmentEnvironment:YES delegate:self];
                    }
