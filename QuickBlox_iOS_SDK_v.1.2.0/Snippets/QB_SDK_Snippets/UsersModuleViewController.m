    ...
    switch (indexPath.section) {
        ...
        case 0:
            switch (indexPath.row) {
                ...
                case 0:{
                    ...
                    if(withContext){
                        [QBUsers logInWithUserLogin:@"iostest" password:@"iostest2" delegate:self context:testContext];
                      
                    }else{
                        [QBUsers logInWithUserLogin:@"iostest" password:@"iostest2"  delegate:self];
                    }
                }
                    break;
                ...
                case 2:{
                    ...
                    if(withContext){;
                        [QBUsers logInWithSocialProvider:@"facebook" delegate:self context:testContext];
                    }else{
        ...
        case 1:
            switch (indexPath.row) {
                ...
                case 1:{
                    if(withContext){
                        [QBUsers userWithID:292 delegate:self context:testContext];
                    }else{
        ...
        case 3:
            switch (indexPath.row) {
                ...
                case 0:{
                    if(withContext){
                        [QBUsers deleteUserWithID:4845 delegate:self context:testContext];
                    }else{
                ...
                case 1:{
                    if(withContext){
                        [QBUsers deleteUserWithExternalID:555 delegate:self context:testContext];
                    }else{
