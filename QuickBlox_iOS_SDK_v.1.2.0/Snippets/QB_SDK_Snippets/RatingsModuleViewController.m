            ...
            switch (indexPath.row) {
                ...
                case 5:{
                    if(withAdditionalRequest){
                        ...
                        if(withContext){
                            [QBRatings scoresWithUserID:292 extendedRequest:getRequest delegate:self context:testContext];
                        }else{
                        ...
                        if(withContext){
                            [QBRatings scoresWithUserID:292 delegate:self context:testContext];
                        }else{
                            [QBRatings scoresWithUserID:292 delegate:self];
                        } 
                    }
                }
                    break;
